          ...
          {users && users.map((user: IUser) => (
            <li className={styles['emp__row']} key={user.id}>
              <div className={styles['emp__item']}>
                <p className={cn(styles['emp__item-text'], styles['emp__item-text_id'])}>{user.id}</p>
                <input
                ...
                />
                <p className={cn(styles['emp__item-text'], styles['emp__item-text_role'])}>{user.role}</p>
                <p className={cn(styles['emp__item-text'], styles['emp__item-text_office'])}>1</p>
                <div className={styles['emp__item-actions']}>
                  <Button onClick={() => deleteUser(user.id)} appearance={'red'} className={styles['emp__item-del']}>
                    <svg width="17" height="20" viewBox="0 0 17 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path
